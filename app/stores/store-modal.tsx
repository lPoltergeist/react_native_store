...
export default function StoreModal() {
    ...
    const { selectedStore, createStore, updateStore, clearSelectedStore } = useStoreStore();
    ...
    return (
        <Box flex={1} bg="$white" p="$6">
            <VStack space="lg">
                <FormControl>
                    <FormControlLabel><FormControlLabelText>Nome da Loja</FormControlLabelText></FormControlLabel>
                    <Input><InputField value={name} onChangeText={setName} /></Input>
                </FormControl>

                <FormControl>
                    <FormControlLabel><FormControlLabelText>Endereço</FormControlLabelText></FormControlLabel>
