...
export const ProductCard = React.memo(({ item, onEdit, onDelete }: ProductCardProps) => {
    return (
        <Box
            bg="$white"
            p="$4"
        ...
        >
            <Box>
                ...
                <Box style={cardStyles.productBadge}>
                    <Text style={cardStyles.productBadgeText}>Preço: R$ {item.price}</Text>
                </Box>
            </Box>

            <Box style={cardStyles.cardActions}>
                <Button
                    style={[cardStyles.buttonDelete]}
                ...
                <Button
                    ...
                    onPress={() => onEdit(item)}>
                    <Text style={[cardStyles.buttonPrimaryText, cardStyles.buttonText]}>Editar Produto</Text>
                </Button>
            </Box>
        </Box>
    );
